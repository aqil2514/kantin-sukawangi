...
//             <Link href={"/checkout"}>
//               <Button className="w-full bg-green-500 text-white hover:bg-green-400 transition-all duration-200 my-auto">
//                 Checkout
//               </Button>
//             </Link>
//             <SheetClose asChild>
//               <Button className="w-full mt-2 bg-red-500 text-white hover:bg-red-400 transition-all duration-200">
//                 Tutup
//               </Button>
//             </SheetClose>
//           </SheetFooter>
